        ...
        <div class="logiciels-competences-projet">
            <div class="un-logiciel">
                ...
                <div class="flex-logiciels">
                    <div class="titre-logo-projet">
                        <img alt="icon-webstorm" src="images/figma-icon.png">
                    </div>
                </div>
            </div>
            <div class="une-competence">
                ...
                <div class="flex-competences">
                    <div class="titre-logo-projet">
                        <img alt="icon-html-5" src="images/figma-icon.png">
                    </div>
                </div>
            </div>
        </div>
...
<section class="projet-section"
    ...
    <img alt="prototype-sketch" src="images/verum-acceuil.jpg">
</section>

<section class="projet-section"
         data-aos="zoom-in-down" data-aos-duration="1000">
    <h1>Premier Prototype</h1>
    <img alt="prototype-lo-fi" src="images/verum-prototypage-low-fi.jpg">
</section>

<section class="projet-section"
         data-aos="zoom-in-down" data-aos-duration="1000">
    <h1>Prototype Avancé</h1>
    <img alt="prototype-hi-fi" src="images/verum-prototypage-high-fi.jpg">
</section>

<section class="projet-section"
         data-aos="zoom-in-down" data-aos-duration="1000">
    <h1>Prototype Final</h1>
    <img alt="prototype-final" src="images/verum-prototypage-final.jpg">
</section>
